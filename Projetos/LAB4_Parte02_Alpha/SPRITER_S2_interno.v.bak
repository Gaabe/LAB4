...
mux_ip MUX_spnum(.data0x(sp0_num), .data1x(sp1_num), .data2x(sp2_num), .data3x(sp3_num), .sel(mux_sel), .result(spriteNumber));
mux_ip4 MUX_spline(.data0x(sp0_line), .data1x(sp1_line), .data2x(sp2_line), .data3x(sp3_line), .sel(mux_sel), .result(lineNumber));
...
mux_offset MUX_spoffset(.data0x(sp0_offset), .data1x(sp1_offset), .data2x(sp2_offset), .data3x(sp3_offset), .sel(mux_sel), .result(spriteOffset));
